                    ...
                    <div className="row text-center">
                      <div className="col-md-3 mb-3">
                        <div className="card partner-wap py-5">
                          <a href="#"><i className="display-1 text-white bx bxs-buildings" /></a>
                        </div>
                      </div>
                      <div className="col-md-3 mb-3">
                        <div className="card partner-wap py-5">
                          <a href="#"><i className="display-1 bx text-white bxs-check-shield bx-lg" /></a>
                        </div>
                      </div>
                      <div className="col-md-3 mb-3">
                        <div className="card partner-wap py-5">
                          <a href="#"><i className="display-1 text-white bx bxs-bolt-circle" /></a>
                        </div>
                      </div>
                      <div className="col-md-3 mb-3">
                        <div className="card partner-wap py-5">
                          <a href="#"><i className="display-1 text-white bx bxs-spa" /></a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row text-center">
                      <div className="objective col-lg-4">
                        <div className="objective-icon card m-auto py-4 mb-2 mb-sm-4 bg-secondary shadow-lg">
                          <i className="display-4 bx bxs-bulb text-light" />
                        </div>
                      ...
                      <div className="objective col-lg-4 mt-sm-0 mt-4">
                        <div className="objective-icon card m-auto py-4 mb-2 mb-sm-4 bg-secondary shadow-lg">
                          <i className="display-4 bx bx-revision text-light" />
                        </div>
                      ...
                      <div className="objective col-lg-4 mt-sm-0 mt-4">
                        <div className="objective-icon card m-auto py-4 mb-2 mb-sm-4 bg-secondary shadow-lg">
                          <i className="display-4 bx bxs-select-multiple text-light" />
                        </div>
